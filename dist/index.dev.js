...
var a; //declaring a varible

a = 5; // ASSIGNING A VALUE TO THE VARIABLE

var age = 20; //declared and instantiate/assigned a value to the variable.

var b = 34;
var d = 6;
console.log("a", a);
console.log("b", b);
console.log("d", d); // Data Types of Variables 
// 1. Numbers 
//     -integers eg. 5
//     - float 5.67989898
//     - double 56.65
...
var firstName = "Jame"; // myAge is a varibel of type integer

var myAge = 30; // KEY WORDS

console.log("Hello World");
console.log(firstName);
console.log(myAge);
console.log("My name is", firstName, "I am ", myAge, "yeas old");
var lastName = "Wanjiku";
console.log(lastName);
console.log("You full name is ", firstName + " " + lastName); // Develop a program that ask th user to enter their names and check of they are 
